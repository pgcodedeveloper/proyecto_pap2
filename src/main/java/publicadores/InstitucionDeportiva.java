...
public class InstitucionDeportiva  implements java.io.Serializable {
    private publicadores.ActividadDeportiva[] actividadesDeportiva;
    ...
    public InstitucionDeportiva(
           publicadores.ActividadDeportiva[] actividadesDeportiva,
    ...
    /**
     * Gets the actividadesDeportiva value for this InstitucionDeportiva.
     * 
     * @return actividadesDeportiva
     */
    public publicadores.ActividadDeportiva[] getActividadesDeportiva() {
        return actividadesDeportiva;
    }


    /**
     * Sets the actividadesDeportiva value for this InstitucionDeportiva.
     * 
     * @param actividadesDeportiva
     */
    public void setActividadesDeportiva(publicadores.ActividadDeportiva[] actividadesDeportiva) {
        this.actividadesDeportiva = actividadesDeportiva;
    }

    public publicadores.ActividadDeportiva getActividadesDeportiva(int i) {
        return this.actividadesDeportiva[i];
    }

    public void setActividadesDeportiva(int i, publicadores.ActividadDeportiva _value) {
        this.actividadesDeportiva[i] = _value;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.actividadesDeportiva==null && other.getActividadesDeportiva()==null) || 
             (this.actividadesDeportiva!=null &&
              java.util.Arrays.equals(this.actividadesDeportiva, other.getActividadesDeportiva()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getActividadesDeportiva() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getActividadesDeportiva());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getActividadesDeportiva(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setFieldName("actividadesDeportiva");
        elemField.setXmlName(new javax.xml.namespace.QName("", "actividadesDeportiva"));
