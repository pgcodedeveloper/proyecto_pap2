           ...
           if(actividad !== "No hay actividades" || actividad !== null){
                ...
                .then(data =>{
                    ...
                    data[1].forEach(d =>{
                        ...
                        dato += d;
                        dato += "<form class='form' action=\"VerClase?clase=" + d + "\" method='POST'><button type='submit' class='badge bg-primary rounded-pill'>Info <i class='fa-solid fa-circle-info' ></i> </button> </form>";
                        dato += "</li>";
